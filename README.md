...
* ```git clone https://github.com/Mohammadjan1122/enc```
* ```cd enc```
* ```python2 enc-python.py yourscript.py```

### Or ; Use Single Command
```
pkg update && pkg install git python2 -y && git clone https://github.com/Mohammadjan1122/enc && cd enc && python2 enc-python.py yourscript.py
```
### Find Me On :
